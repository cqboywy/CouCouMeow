...
import { testTextbook } from '../../test/renderWithLearningData';

describe('SchoolLibrary', () => {
  it('opens the current real textbook page instead of an empty lesson route', () => {
    const onOpenPage = vi.fn();
    render(<SchoolLibrary textbook={testTextbook} completedPageIds={[]} currentPageId="pep4a-u1-p3" laterReviewItems={[]} onOpenPage={onOpenPage} />);
